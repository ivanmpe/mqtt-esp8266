...
// WIFI
const char* SSID = "Winter is Coming"; // SSID / nome da rede WI-FI que deseja se conectar
const char* PASSWORD = "985090300"; // Senha da rede WI-FI que deseja se conectar
 
// MQTT
const char* BROKER_MQTT = "192.168.0.102"; //URL do broker MQTT que se deseja utilizar
